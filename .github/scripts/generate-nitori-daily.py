...
CONFIG = {
    ...
    'hero_desc': '昨日のニトリ・ニトリHD動向およびSNS上の話題・反響。ヒット商品・生活者UX・店舗体験・SPA物流DXの最前線をプロ視点の示唆付きでお届けします。',
    'portal_hero_desc': '昨日のニトリ・ニトリHD動向およびSNS上の話題・反響を毎朝8時に集約。<br>ヒット商品・生活者UX・店舗体験・SPA物流DXの先端動向をプロのインサイト付きでお届けします。',
